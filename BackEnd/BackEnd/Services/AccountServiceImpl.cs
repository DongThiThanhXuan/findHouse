    ...
    public class AccountServiceImpl : AccountService
    {
        ...
        public bool Create(Account account)
        {
            try
            {
                ...
                string message = $"<html><body><p>Active Message</p><p>Infor Account</p><p>Username : {account.Username}</p><p>Fullname : {account.Fullname}</p><p>Phone: {account.Phone}</p><p>Address: {account.Addresss}</p><p>Please click this button to active your account</p><button><a href='http://localhost:4200/verify;username={account.Username};activeCode={verifyCode}'>Active</a></button></body></html>";
        ...
        public string SendVerifyCode(string username)
        {
            try
            {
                ...
                string message = $"<html><p>This is your very code: {verifyCode}</p><p>This code is only valid for 5 minutes</p></html>";
        ...
        public bool CreateBySuperAdmin(Account account)
        {
            try
            {
                ...
                string message = $"<html><body><p>Active Message</p><p>Infor Account</p><p>Username : {account.Username}</p><p>Password : {password}</p><p>Phone: {account.Phone}</p></body></html>";
