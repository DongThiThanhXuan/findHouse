...
export class AddUpdatePackage implements OnInit {
  ...
  id: number;
  constructor(
    private formBuilder: FormBuilder, private pacSer: PackageService, private check: Check, private message: MessageService, private activateRoute: ActivatedRoute, private router: Router
  ) {
